...
sudo snap install --classic code -y # or code-insiders
# GIT
...
sudo snap install dbeaver-ce pencil-snap-demo onlyoffice-desktopeditors obs-studio vlc pdfarranger clamav -y
# windows burner
